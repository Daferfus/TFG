...
def test_nou_alumne_amb_fixture(nou_alumne):
    ...
    assert nou_alumne.distancies == {"Punt de Partida": "Gandía", "Punt de Destí": "València", "Distància": 8}
    assert nou_alumne.assignacio == {"Alumne": "David Fernández Fuster", "Pràctica": "Locatec_(Pràctica 01)", "Professor": "Juan Miguel Alberola Oltra"}
...
def test_nou_professor_amb_fixture(nou_professor):
    ...
    ENTONCES comprobar que els camps nom, cognoms, titulacions, hores_alliberades, hores_restants, 
    ...
    assert nou_professor.assignacions == [{"Alumne": "David Fernández Fuster", "Pràctica": "Locatec_(Pràctica 01)", "Professor": "Juan Miguel Alberola Oltra"}]
...
def test_nova_empresa_amb_fixture(nova_empresa):
    ...
    ENTONCES comprobar que els camps nom, poblacio, telefon, correu, 
    ...
    assert nova_empresa.assignacions == [{"Alumne": "David Fernández Fuster", "Pràctica": "Locatec_(Pràctica 01)", "Professor": "Juan Miguel Alberola Oltra"}]