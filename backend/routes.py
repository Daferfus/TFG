...
@app.route('/recuperar_dades_del_alumne/<alumne>', methods=['GET'])
...
@app.route('/recuperar_dades_de_professors', methods=['GET'])
...
@app.route('/recuperar_dades_del_professor', methods=['GET'])
...
@app.route('/recuperar_dades_de_empreses', methods=['GET'])
...
@app.route('/recuperar_dades_de_la_empresa', methods=['GET'])
...
@app.route('/recuperar_dades_de_usuaris', methods=['GET'])
...
@app.route('/recuperar_dades_del_usuari', methods=['GET'])
